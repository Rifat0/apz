				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<label class="radio-inline">
							<div class="form-group">
								<input type="radio" name="gender"  class="radio-primary" value="Male">
								<p style="font-size:16px;"><b>Male</b></p>
							</div>
						</label>
						<label class="radio-inline">
							<div class="form-group">
								<input type="radio" name="gender"  class="radio-primary" value="Female">
		...
		$("#super_admin_add").validate({
			...
			submitHandler: function(form) {
				...
				$.ajax({
					...
					type: "post",
					data: $('#super_admin_add').serialize(),
					success: function( response ) {
