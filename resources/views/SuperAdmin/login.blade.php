...
<html lang="{{ app()->getLocale() }}">
	<head>
		...
		<title>{{env('APP_NAME')}} || {{ Request::segment(1)??'Login' }}</title>	
	...
	<body class="gray-bg">
		...
		<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.0/jquery.validate.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.0/additional-methods.min.js"></script>
