...
@section('style')
<link href="{{asset('public/dashboard/css/plugins/summernote/summernote.css')}}" rel="stylesheet">
<link href="{{asset('public/dashboard/css/plugins/summernote/summernote-bs3.css')}}" rel="stylesheet">
@endsection
			...
			<form action="javascript:void(0)" id="tc_form" enctype="multipart/form-data">
				...
				<div class="row">
					  <div class="col-sm-2">
						<div class="thumbnail">
							...
							<img src="{{asset('public/uploads/document')}}/{{$document}}" class="thumbnails">
				...
				<div class="form-group row">
					<div class="col-sm-4 col-sm-offset-4">
						...
						<button type="submit" class="btn btn-success btn-block save">Save</button>
					</div>
				</div>
			</form>
		</div >
...
@section('script')
<script type="text/javascript" src="{{asset('public/dashboard/js/plugins/summernote/summernote.min.js')}}"></script>
 <script>
